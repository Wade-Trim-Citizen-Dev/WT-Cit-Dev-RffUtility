...
The app logo (`assets\logo.png`, 512 px) and the multi-size icon
(`assets\icon.ico`, 16–256 px) are generated by `assets\make_logo.py`:

```bat
venv\Scripts\python assets\make_logo.py
```
